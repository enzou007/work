    ...
    return (
      <FlowForm   onCreate={this.onCreate} onBeforeSubmit={this.beforeSubmit} onSubmit={this.afterSubmit}  readOnly={this.state.readonly}>
        <div className="form-content" tab="基本信息">
          ...
          <FormControl label="订单日期" name="efct_date" type="date" />
          <FormControl label="产品名称" name="trade_name" type="text"/>
          <FormControl label="产品金额" name="ord_amt" type="number" />
          <FormControl label="订单金额" name="trade_amt" type="number" />
          <FormControl label="欠款金额" name="q_amt" type="number" />
          </div>
