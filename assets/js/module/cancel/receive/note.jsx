    ...
    return (
      <FlowForm   onCreate={this.onCreate} onBeforeSubmit={this.beforeSubmit} onSubmit={this.afterSubmit}  readOnly={this.state.readonly}>
        <div className="form-content" tab="基本信息">
          ...
          <FormControl label="付款方名称" name="p_name" type="text"/>
          <FormControl label="付款方银行账户" name="p_bank_act" type="text"/>
          <FormControl label="客户编号" name="cust_id" type="text"/>
          <FormControl label="我方收款银行账户" name="r_bank_acct" type="text" />
          <FormControl label="到款日期" name="r_date" type="text" />
          <FormControl label="到款时间" name="r_time" type="date" />
          <FormControl label="币种" name="currency" type="select" data={bzdata}/>
          <FormControl label="到款金额" name="r_amount" type="number" />
          <FormControl label="可核销金额" name="a_amount" type="number" />
