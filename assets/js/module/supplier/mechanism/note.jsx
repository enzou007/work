    ...
    return (
      <DataForm  title ="供应商" onCreate={this.onCreate} onBeforeSubmit={this.beforeSubmit} onSubmit={this.afterSubmit}  readOnly={this.state.readonly}>
        <Fieldset title="基本信息">
            ...
            <FormControl label="供应商状态" name="cust_status" type="radio-group" data={KHLXData} value="生效"  responsive={{xl: 12}}/>
            ...
            <FormControl label="税务登记(国税)"  name="tax1_id_p" type="file"   responsive={{xl: 24}}/>
            <FormControl label="税务登记号(地税)" name="tax2_id" type="text"   responsive={{xl: 24}}/>
            <FormControl label="税务登记(地税)"  name="tax2_id_p" type="file"   responsive={{xl: 24}}/>
        </Fieldset>
